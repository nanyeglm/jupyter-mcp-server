...
- More environment variables can be set, refer to the [server configuration](/configuration) for more details. If not specified, the server will use the default values.
