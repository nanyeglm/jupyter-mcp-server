...
Replace `// Jupyter MCP Server configuration` with the actual configuration details from the [Jupyter MCP Server documentation](/clients).
...
Update with the actual configuration details from the [Jupyter MCP Server documentation](/configure).
